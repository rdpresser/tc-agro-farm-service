...
global using TC.Agro.Farm.Application.UseCases.Plots.GetById;
global using TC.Agro.Farm.Application.UseCases.Plots.ListByProperty;
global using TC.Agro.Farm.Application.UseCases.Sensors.GetSensorById;
global using TC.Agro.Farm.Application.UseCases.Sensors.ListFromPlot;
global using TC.Agro.Farm.Domain.Aggregates;
global using TC.Agro.Farm.Domain.Snapshots;
global using TC.Agro.Farm.Infrastructure.Extensions;
