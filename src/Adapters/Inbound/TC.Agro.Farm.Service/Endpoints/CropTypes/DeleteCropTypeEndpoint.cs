...
namespace TC.Agro.Farm.Service.Endpoints.CropTypes
{
    public sealed class DeleteCropTypeEndpoint : BaseApiEndpoint<DeleteCropTypeCommand, DeleteCropTypeResponse>
    {
        public override void Configure()
        {
            ...
            Summary(s =>
            {
                s.Summary = "Deactivate a crop type suggestion.";
                s.Description = "Performs a logical deletion by deactivating a crop type suggestion.";
                s.ExampleRequest = new DeleteCropTypeCommand(Guid.NewGuid());
                s.Responses[200] = "Returned when the crop type suggestion is successfully deactivated.";
