...
{
    public sealed class CreateSensorEndpoint : BaseApiEndpoint<CreateSensorCommand, CreateSensorResponse>
    {
        ...
        public override void Configure()
        {
            ...
            Summary(s =>
            {
                ...
                s.ExampleRequest = new CreateSensorCommand(
                    Guid.NewGuid(),
                    faker.PickRandom(SensorTypes),
                    "Sensor Norte 1");
                s.ResponseExamples[201] = new CreateSensorResponse(
                    Guid.NewGuid(),
                    Guid.NewGuid(),
                    "Temperature",
                    "Active",
        ...
        public override async Task HandleAsync(CreateSensorCommand req, CancellationToken ct)
        {
