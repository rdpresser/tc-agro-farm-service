...
{
    internal sealed class GetPropertyByIdQueryHandler : BaseQueryHandler<GetPropertyByIdQuery, GetPropertyByIdResponse>
    {
        ...
        public override async Task<Result<GetPropertyByIdResponse>> ExecuteAsync(
